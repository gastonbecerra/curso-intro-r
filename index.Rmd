...
Estos recursos corresponden a un seminario de [sociología y epistemología del big data](https://www.academia.edu/48345036/Sociolog%C3%ADa_y_epistemolog%C3%ADa_del_Big_data) como un fenómeno tecnológico, social y cultural. El presente material corresponde a la unidad práctica de dicho seminario, que busca introducirnos en análisis de datos por medio del lenguaje R. Si bien este objetivo es explícitamente de nivel introductorio, creemos que puede ser un primer paso hacia un fin necesario: acercarnos al fenómeno de los datos, con una mirada *desde adentro*.
