...
Los resultados arrojados por el modelo pueden ser útiles para inferir tópicos. No obstante, esto implica un proceso de interpretación cualitativo por parte del investigador, que comienza con el "etiquetado", y en el que se deben tomar varias decisiones metodológicas, así como atender a sus desafíos.
...
Generalmente, el análisis de los tópicos supone varios momentos:
