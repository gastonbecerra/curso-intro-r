...
oraciones <- readr::read_csv(file = "data/oraciones_bd3.csv") # importamos datos
...
La *lemmatización* es un procedimiento que busca reducir las palabras a su forma no flexionada o conjugada. Es una alternativa a la *stemmization*, que intenta reducir heurística e iterativamente la extensión de las palabras, removiendo caracteres, hasta reducirlas a su raíz.[^1] 

[^1]: Así, la expresión "Google analiza big data para inferir el ritmo de contagio de la gripe H1N1”, que da lemmatizada como "google analizar bigdata inferir ritmo contagio gripe h1n1".
